...
<html lang="pt-br">
    <head>
        ...
        <title>Jess Design Nails - lista os pagamentos</title>
    </head>
    <body>
        <?php
        ...
        ?>
        <div class="container">
            <h2 class="display-4 mt-3 mb-3">Pagamentos PicPay</h2>
            <?php
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <?php
                $query_payments ="
                SELECT pay.id, pay.first_name,
                pay.email,prod.name AS name_prod,
