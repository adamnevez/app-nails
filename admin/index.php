...
<html lang="pt-br">
    <head>
        ...
        <title>Nails App - Login</title>
    </head>
    <body>
        <?php
        // $password_encrypted = password_hash("193750", PASSWORD_DEFAULT); echo $password_encrypted;
        ...
        <form method="POST" action="" class="form-signin">
            <div class="text-center mb-4">
                <img class="mb-4" src="../images/logo/logonails.jpeg" alt="" width="100" height="100">
            ...
            <div class="form-label-group">
                ...
                "<?php if(isset($data['email'])) { echo $data['email']; } ?>" autofocus>
